...
const PROJECTS = [
  ...
  { name: "Lanternlight", path: "/gms/3d/lanternlight/", screenshot: "lanternlight", type: "game",
    desc: "\u201cJust leave me alone,\u201d the eldest said \u2014 and for once, the little ones listened. They followed a lantern that floated all by itself into the Gloaming, and now someone has to bring them home. Play as Ivy or Rowan across five hand-scripted chapters in portrait: run a moonlit night garden, ride a paper boat down a river of floating lanterns, glide on an umbrella between drifting sky-islands at sunset, and face the Hush \u2014 a great moth that keeps every light that was ever lost \u2014 before flying home on the back of the morning. Your lantern is your life: fireflies feed it, shadows drain it, and a tap of SHINE burns them away. Fully voiced (a narrator, both older siblings, Pip and Bean) with local Qwen voices, procedural Three.js characters and worlds, bloom, and a happy ending. Drag to steer, tap to jump.",
    date: "2026-09-25", creator: "Opus 5.5" },

  { name: "TINPOT", path: "/gms/3d/tinpot/", screenshot: "tinpot", type: "game", wip: true,
    desc: "A tinpot general fights a tinpot war with tinpot men. Tap the ground and your lads trot there; they shoot whatever wanders into range entirely by themselves, so the whole tactical game is one toggle — four unit cards along the bottom edge, tapping one takes that man out of the marching order and leaves him holding where he stands. Peel one off to cover a gap while the other three swing wide and you have flanked something. A rail of weapon buttons climbs the left edge: one tap arms the entire squad, or use the pips on a single card to make just him a grenadier. The forest is the wall and the wall is flammable — a grenade takes a bite out of the treeline, the bite catches, fire crawls tree to tree with the wind, burns itself out, and leaves a scar of charred ground that is now walkable, so routes that did not exist at the start of a mission exist by the end of it, including ones the enemy can use on you. Maps are territory rather than levels: win a clearing and the next mission on it opens with your own sandbags standing where you won and last mission's burn scars still on the grass. Men who live get promoted and shoot straighter; men who do not get a small wooden cross and the next name on the list steps up, worse at everything. Held in one hand in portrait, seen from a camera tilted just far enough off vertical that a tin helmet has a lit side and a long dawn shadow. Vanilla JavaScript and Three.js, procedural geometry throughout, no build step, no CDN and no dependencies.",
    date: "2026-09-22", creator: "OpenAI Codex / GPT-6 Astra + Opus 5" },

  { name: "SUNWAKE", path: "/gms/3d/sunwake/", screenshot: "sunwake", type: "game",
    desc: "A wooden launch, an endless sea, and a sun that never quite sets. Steer out across four octaves of real swell \u2014 the hull heaves, pitches and rolls because four buoyancy points are actually sampling the water under it, not because anything is faking a wobble \u2014 and go and look at whatever breaks the horizon. Limestone islands rise out of a deterministic archipelago that goes on as far as you care to sail, and their shores are properly solid: a continuous swept-circle solver, proven across a twenty-kilometre route and a hundred thousand randomised cases, so no speed and no angle will ever put you through the rock. Sunset sky reflected off a GGX specular sea, a glitter road that breaks over the wave faces and swings away as you turn, shore foam, wake and spray. One thumb on a split helm on a phone, WASD on a desktop, and a chase camera that keeps the horizon level so you can sail for an hour. Vanilla JavaScript and Three.js, entirely procedural geometry and textures, no build step, no CDN and no dependencies.",
    date: "2026-09-19", creator: "OpenAI Codex / GPT-6 Astra + Opus 5" },
  ...
  { name: "Tidekeeper II",   path: "/gms/3d/tidekeeper2/", screenshot: "tidekeeper2", type: "game",
    desc: "A second, gentler run at the aquarium game, and this one starts with a single fish and a single button. There is no menu, no shop and no interface at all \u2014 just forty litres of lit water and one sentence asking whether you would like a fish. You pick one, it drops in with a splash, you feed it, people start coming in to look, and that is the whole game until you have proved you can keep it alive for three days. Then the second tank arrives, and the first one carries on by itself. Everything after that is earned: twenty-six species across six shelves, planting, hardscape, equipment, a test kit that replaces the single Water dial with the real numbers, fast-forward, auto-feeders that keep a tank earning while the game is closed, salt water, breeding, photo mode. The dock physically grows a button at a time as you unlock things. New species mostly arrive through collecting trips \u2014 a small roguelike where a boat makes three stops, you take one of three cards at each, and rare animals cost condition you may not have to spare. Underneath is the same honestly-modelled tank as the first game: temperature, pH, oxygen, and an ammonia-to-nitrite-to-nitrate cycle whose bacteria have to actually grow, so a new tank poisons whatever goes in it first and a mature one shrugs off a mistake. Overfeed and the water turns; overstock and the filter simply cannot keep up however long you wait; plant it heavily and the nitrate goes to zero and algae never gets a foothold. The relationships are the game: an angelfish is harmless to neon tetras until its mouth passes nine centimetres, a betta shreds anything with trailing fins, a pea puffer eats your cleanup crew, a seahorse starves quietly beside anything quick, a mandarin dragonet starves in a young tank surrounded by food it will not eat. Placing a fish shows a green-amber-red line saying exactly what will go wrong. Everything is procedural \u2014 fish are built from a silhouette function and a pattern function, with scales, translucent ray-veined fins, countershading and a fresnel sheen, swum on the GPU so a shoal is one draw call. Photographic sand, stone and driftwood, animated caustics, shafts of light through the surface, per-channel light absorption so red goes first, and a dark room with one bright tank in it. Three.js vendored rather than fetched, no build step, mobile-first.",
    date: "2026-09-13", creator: "Opus 5" },

  { name: "Tanking", path: "/gms/3d/tanking/", screenshot: "tanking", type: "game",
    desc: "A living aquarium balanced between sustainability and spectacle. Sixteen procedural species school, patrol, hunt, hide, and breed in swaying underwater gardens. Manage the nitrogen cycle, discover surprising neighbours, and grow a public aquarium across eight modes. Animated caustics, moonlit nights, cinematic fish following, ambient audio, and a photographic lens. One self-contained HTML file, powered by Three.js.",
    date: "2026-09-12", creator: "OpenAI Codex / GPT-6" },

  { name: "Tidekeeper",      path: "/gms/3d/tidekeeper/", screenshot: "tidekeeper", type: "game",
    desc: "An aquarium management game about the fight between a tank that survives and a tank that dazzles. You own the water: temperature, pH, oxygen, and the ammonia-to-nitrite-to-nitrate cycle that a new tank cannot run yet, because the bacteria that do that job have not grown. Overfeed and the water turns against you; overstock and the filter simply cannot keep up however long you wait; plant it heavily and the nitrate goes to zero and the algae never gets a foothold. Eighteen species, each with a water type, a swim zone, a temperament, an adult size, a bioload, a minimum school and an appeal score \u2014 and each with the relationship that ruins somebody\u2019s afternoon. An angelfish is harmless to neon tetras until its mouth grows past nine centimetres. A betta reads long trailing fins as a rival flag and shreds them. Puffers eat your snails. Cleaner shrimp run a clinic that halves how fast disease spreads. Seahorses feed one item at a time and starve quietly beside anything quick. Goldfish are magnificent and load a tank like six tetras each. Placing a fish shows a live green-amber-red preview with one line saying exactly what will go wrong, and the interactions you have not met yet stay hidden until they happen to you, then get written up in an unlockable Aquapedia. Everything is procedural \u2014 no models, no textures. Fish are built from a silhouette function and a pattern function and swum on the GPU with a body wave, beating pectorals and a fluttering dorsal, so a school of forty is one draw call and every fish is out of phase with its neighbours. Animated caustics on the sand and the glass, shafts of light from the surface, depth fog, drifting marine snow, plants that sway in the current, bioluminescence that is worth double after dark and almost invisible under gallery lighting, and a day cycle that ends in moonlit blue. Orbit anywhere, tap any fish to follow it cinematically. Eight ways to play: a six-chapter Career from a twenty-gallon starter to a public aquarium, six Scenario puzzles including rescuing a tank mid-crash, a timed Showtime festival, endless Survival against power cuts and ich outbreaks, a Draft Run where you take one of three species every other day, Conservation breeding for release, a seeded Daily Reef, and a Zen sandbox with a photo mode that does real depth of field. One HTML file, Three.js vendored rather than fetched, no build step, mobile-first.",
  ...
  { name: "Who Fights",      path: "/gms/3d/whofights/", screenshot: "whofights",     type: "game", wip: true,
    desc: "An adventurers' guild game, and the toolkit being built to make it. You start on a road in a dark cloak outside a pale limestone castle, under a sign reading Adventurer Academy, and walk in through doors that stand permanently open into a great hall hung with contract boards \u2014 Iron, Bronze, Gold, and one for New Adventures \u2014 where a white-cloaked instructor paces between them. Gentle meadow and a few trees outside, and for now that is the whole world: the game is the smaller half of this project. The larger half is a developer mode that appears only when the page is served from localhost or a LAN address, and opens a full editing suite over the running game \u2014 a level editor that draws hotspots straight onto the ground and wires them to conversations, level changes, music cues or flags; a conversation editor that shows every place a line is triggered from and can invent a narrator or a bodiless NPC mid-sentence; a character viewer that retints and reshapes the hooded figure live and auditions Kokoro voices against a written pool of idle and grumble lines; a music box that assigns sets of tracks to rooms and crossfades them in a doorway; and a rack of debug panels for teleporting, tracing fired actions and reading the frame budget. Nothing is hardcoded \u2014 the world is a JSON document the tools write and the game reads. Three.js, no build step, mobile-first portrait and landscape, with an authoring server that reaches local Kokoro, ACE-Step and Flux models.",
    date: "2026-08-30", creator: "Opus 5" },

  { name: "SILT",            path: "/gms/2d/silt/",      screenshot: "silt",          type: "game",
    desc: "A falling-sand puzzle where the sand is lit rather than drawn. Pieces drop, shatter into loose grains and flow — and when one colour reaches from the left wall to the right the whole chain lights up and dissolves into drifting motes. Nothing is rendered as a cell: the grid becomes a density field, gets a surface, and takes a warm key and a cool rim, so a heap reads as a dune with a lit crest and a shadowed slope and water refracts what is behind it. Six modes across five biomes. FLOW is endless sand. TIDE floods the floor, and because a chain is any one colour spanning the board, coloured water finishes coloured chains — the rising flood is a resource as well as the thing that drowns you. JELLY LAB replaces grains with soft bodies that squash, wobble and fuse, clearing only when pressure spreads them wall to wall. HOURGLASS turns the board over every thirty seconds and your pile becomes weather. ALCHEMY is a graded campaign of puzzles built on real chemistry — water quenches lava into crystal, and crystal is forever, so the wall in your way is usually one you built. ZEN has no score, no ceiling and no end. Three colours, not four: a colour holding a quarter of the board cannot span a lattice whose percolation threshold is two fifths, so the difficulty lives in the falling speed and the variety lives in the materials. Vanilla JS and WebGL2, no build step, no CDN, no dependencies, mobile-first portrait.",
    date: "2026-08-28", creator: "Opus 5" },

  { name: "SKYHAMMER",       path: "/gms/2d/skyhammer/", screenshot: "skyhammer",     type: "game",
    desc: "A side-scrolling war-plane game for one thumb. Put a finger anywhere and the nose follows it — circle your thumb and the aeroplane loops — while the guns fire themselves and four big buttons drop whatever ordnance you loaded in the hangar. It starts as a wooden biplane over WW2 farmland and ends somewhere with tactical nukes on the upgrade tree, across 100 missions in five acts: bomb the outposts, duel the fighters, catch the supply balloons, and put down on a carrier deck inside a small green box with your wings level. The camera holds a low horizon and a big warm sky until you climb into the top of the frame, then follows you up — and the top of the sky is genuinely safer, because the flak cannot reach it. Ground fire tops out below the ceiling, so you climb to escape and dive to attack. Between missions you spend the money on a faster, tougher, better-armed aircraft, or on the bombs themselves: cluster, firebomb, bunker buster, seeker, and several that are simply silly. Explosions light the terrain, buildings lean and break into tumbling pieces, and you survive your own blast. Three.js rendered side-on, vanilla JS, no build step, mobile-first landscape.",
    date: "2026-08-26", creator: "Opus 5" },
  { name: "KITEHAWK",        path: "/gms/2d/kitehawk/",  screenshot: "kitehawk",       type: "game", status: "cancelled",
    desc: "A painterly biplane game about altitude. You fly one thumb — hold and slide, the throttle looks after itself, the guns fire in a cone off the nose — and everything else is where you are in the column of sky. Six bands from the Mud at the deck to the Blue at the top, and a fight is won or lost on which of them you are in when it starts. Supply crates come down under parachutes and they are the whole economy: fly through one to catch it, or cut its canopy and let it fall, which is what you do to a crate you were never going to reach. Real aerodynamics underneath — a stall you can feel, a dive that takes the whole screen to pull out of, structural stress that will take a wing off if you ask too much. Vanilla JS and WebGL2, no build step, no CDN, mobile-first in landscape. Cancelled part-built. It flew and it fought and a level played start to finish, but the portrait framing and the crate economy never came together into something fun, and it was restarted from scratch as SKYHAMMER rather than patched.",
    date: "2026-08-25", creator: "Opus 5" },

  { name: "FORGE",          path: "/gms/3d/forge/",     screenshot: "forge",          type: "game", wip: true,
    desc: "An RPG in a valley where there is no mundane skill. Fishing is a school of magic, and so are cooking, mending, building, trading, foraging, culling and fighting — ten schools in all, drawn from a seam of raw power everyone calls the Forge. Two hundred years ago one craft-hall split over how hard to draw on it: the slow half walked west and walled Whitewall on the chalk, the hard half walked east and walled Blackstone on the basalt, and the kitchen and field staff nobody counted stayed in the middle, ploughed the outcrop they were standing on and told no one it was there. You play one character across all three campaigns, Light unlocking Dark unlocking Neutral, and the point is that the later ones do not add facts to the earlier — they overturn them. Thirty-four Truths across eleven chains, and when one is contradicted the journal strikes the old line through and writes what replaced it underneath. Ninety-nine quests, level cap 20, a world clock and calendar running under all of it. Take the licence for the granary rats, fish the ford, mine, cook what you catch, and walk between towns on roads that are actually there. Three.js, no build step, mobile-first in portrait or landscape, with the level editor that built the world shipping alongside it. In active build: two of the three towns are hand-authored, Blackstone is still procedural, and balance is the next pass.",
    date: "2026-08-20", creator: "Opus 5" },
  ...
  { name: "Sunderfall",         path: "/gms/2d/sunderfall/game/", screenshot: "sunderfall", type: "game",
    desc: "A painterly 2D roguelite platformer where destruction is the mechanic, not the decoration. You are Rook, the spare son of a village blacksmith, handed a dying elder's magic because there was nobody else in the room — and the wood you have to walk into remembers everything you do to it. Fire needs fuel and spreads through it, so a bolt into a timber fence runs the length of the fence and then goes out where the wood ran out; acid flows downhill and eats what it is sitting on; every structure is solved for real support, so knocking a buttress out from under an arch brings the arch, the wall course above it and the second arch down in a cascade rather than a single frame. Ground is a destructible heightfield that craters and chars. It opens on a 76-second hand-animated cinematic — the elder losing a fight you arrive too late for, the seal that costs him everything, and the walk out to find what is left. Eighteen spells across six schools sit on cast circles that unlock as you level: circle one is yours to aim, the rest fire themselves off a focus pool, so the build decides what happens around you while you decide where to stand. Nine enemy types and a boss. Mobile-first: hold anywhere on the left to move, tap the right to jump, and the spells aim themselves at whatever is nearest unless you drag to override. Vanilla JS on a custom WebGL2 renderer — 11,000 sprites, 10,000 particles and 49 lights in 15 draw calls — with painted Flux-generated parallax and every character and effect drawn procedurally in code so a spell going off next to Rook actually lights him. No build step.",
    date: "2026-08-09", creator: "Opus 5" },

  { name: "HOMEBOUND",          path: "/gms/3d/homebound/", screenshot: "homebound",  type: "game", wip: true,
    desc: "A decorated soldier walks home from a war that has not finished with him, and the road is four hundred kilometres of other people's territory. A gate-runner played on one thumb in portrait: steer a squad down a road lined with signs, and every row makes you pick one — a gate that adds men, one that pays cash, one that upgrades the gun, one that is a trap. Your own fire is the second decision, because shooting a wooden sign makes its number climb while you close on it, so a +2 becomes a +56 if you spend the approach on it and ignore the wall of red waiting at the end of the straight. Glass panels are the fixed price that breaks if you shoot them; buttons want shooting; a ? gate pays out at random and occasionally halves the army instead. The squad merges as it grows, so one figure on the road can stand for two men or five hundred and twelve thousand still reads as a formation rather than a carpet. Between runs the money buys the squad it takes to clear the next chapter, and the game is built so it will beat you until you have bought it. Four chapters: the walk home, the debt waiting there, a stretch of contract work, and the hundred-and-twenty-level campaign after it, plus repeatable missions and timed events. Three.js, no build step, mobile-first portrait, offline, with the whole crowd on one draw call and the run gait done in the vertex shader.",
    date: "2026-09-01", creator: "Opus 5" },
  ...
  { name: "RAGDOJO",            path: "/gms/2d/ragdojo/",   screenshot: "ragdojo",     type: "game",
    desc: "A stick-fighting game that happens on an actual sheet of lined paper — ruled lines, red margin, punched holes, and every figure drawn in wobbling pencil that redraws itself eleven times a second so the whole thing boils like hand-drawn animation. You start in a white bandana and fight up through nine ranks to the Ink Master across 45 bouts, and your own bandana drifts above and below your opponent\'s, so nine of those fights you walk into as the underdog and the extra rank pays out in ink if you win. Everyone is a real ragdoll: one verlet skeleton whose muscles pull it toward a posed target, so a light hit staggers, a heavy one cuts the muscles entirely and the body tumbles, skids and settles on the page leaving graphite scuffs and ink splatter behind it. Specials are drawn, not tapped — slash a / for a power hit, the top half of an O to lob a rubber band, a clockwise circle to flip-kick forward and an anticlockwise one to flip away, an arrow up to launch, down to slam, forward to dash, a V to throw an eraser bomb — and each is bought and then upgraded twice over, once for power and once for cooldown, with its gesture animating on its own shop card so you learn the input while you buy it. Ten more upgrades sit behind them, from max health and crit to how fast you get up off the floor. Blocks break under heavy hits, combos scale, and the page itself joins in: a giant pencil stabs down at a marked spot, an eraser sweeps through at shin height, coffee spreads, a draught drags everything sideways, and the paper tears open into a hole. One thumb on a fixed four-way stick, the other tapping and drawing. Beat the Ink Master and Bully Mode hands you every upgrade maxed and sends you back to the white belts, which is exactly as one-sided as it sounds. Vanilla JS on Canvas 2D with a Suno soundtrack, no build step.",
    date: "2026-09-01", creator: "Opus 5" },

  { name: "Breachpoint II",     path: "/gms/3d/breachpoint2/", screenshot: "breachpoint2", type: "game", wip: true,
    desc: "You learned to shoot at a paintball park, and then a real war turned up. It opens on a Saturday at the yard with a rifle marker, two mates in bibs and a bored employee running the range over a PA — and the PA cuts to an emergency broadcast mid-sentence. You are conscripted on the strength of your paintball record, handed a live rifle by a corporal who finds this funny, and sent to take the dock at the end of the same yard you were just playing in. The training splats are still on the containers when you get there, and they stay for two more levels before they fade. Nine levels across one shipping yard that is re-lit, re-populated and physically rebuilt each time: five container layouts move the corridors and chokepoints around, so the sniper parapet that overlooks 72% of the map on one level sees 1% of it on another, and each level inserts you somewhere different — attacking the quay from the west on one, waking up inside the building on the next. Four objective types, seven weather and time-of-day presets, and fog that shortens the enemy’s sight range as well as yours rather than just greying out the screen. Every kill pays service points into six upgrade tracks and a weapon unlock ladder, and the whole game is built on a gate: each enemy tier carries an armour-penetration value that eats into what your plating absorbs, so a fully upgraded shield makes the first level’s conscripts almost harmless at 0.9 HP a hit while the last level’s regulars still take 9.7 — the same investment, an order of magnitude apart. The armoury tells you exactly what that means before you spend anything: how many seconds of open ground the level in front of you currently gives you, and whether the next rank of plating or of health buys more of them. It is honest to within 4% of what the game actually does to you, which took three passes and an admission that the first model was wrong. Replaying a cleared level pays 40% — grinding always works, and it is deliberately the slow road. Bosses are the same soldier, slightly larger, announced by name whether or not you happen to be looking at them. Mobile-first: one thumb moves, the other looks, and a double-tap on the look side fires — hold the second tap down to keep firing. One local copy of three.js, no build step, nothing fetched. Not yet human-played.",
    date: "2026-09-18", creator: "Opus 5" },
