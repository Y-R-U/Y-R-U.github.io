...
const PROJECTS = [
  ...
  { name: "8:20",           path: "/br8t/",             screenshot: "br8t-820",       type: "app",
    desc: "The new br8t.com base site: the life story of the light hitting your screen, told as one scroll-driven WebGL journey. Born in the Sun's core, lost 100,000 years in the radiative-zone random walk (with a live year counter and a cursor-reactive photon trail), breaking out of the photosphere, past Mercury and Venus at light speed under a running T+ mission clock, scattered blue across the sky, and spent on a human retina whose pupil reacts to your cursor. Eight raw-GLSL fragment-shader scenes, a fully synthesized Web Audio soundtrack, live counters (sunlight departure clock, photons into your eyes). No images, no video, no libraries — every frame is drawn by the GPU from mathematics. Desktop landscape + mobile portrait.",
