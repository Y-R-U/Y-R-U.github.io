...
const PROJECTS = [
  ...
  { name: "Racketeer",          path: "/gms/2d/racketeer/", screenshot: "racketeer", type: "game",
    desc: "A silly tennis career game: cheat your way from unranked in a Tesco overflow car park to World #1. Drag to aim, release as the ring closes for perfect timing, two-tap serves — then fight dirty with a 13-skill deck of upgradeable tricks: competition-grade Grunts, Heckling, Umpire Arguments, tweener/backflip Outrageous Shots, Underarm Serves, Fake Injuries, Racket Smashing, bullet-time Zone, and Clive the attack pigeon. Crowd hype multiplies your prize money, opponents play every trick back at you as you climb 8 tiers of increasingly deranged silly-named rivals (Gary from Accounts → Grand Slam of Slams), and the world #1 awaiting you at the top is a sentient ball machine. Pseudo-3D canvas, procedural characters and synth audio, no build step.",
