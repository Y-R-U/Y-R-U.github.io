...
import { initMurder, setMurderVisual } from './murder.js';
...
function resetZone() {
  ...
  state.zoneTimer = MURDER.graceTime;
}
...
function spawnTanks(count, withPlayer, spawnR = 38) {
