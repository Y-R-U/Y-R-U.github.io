...
export default Object.freeze([
  Object.freeze({
    ...
    edge: Object.freeze([
      'Real money in the bank, and enough of it to buy a fleet outright',
    ...
    loan: Object.freeze({ interestWeekly: 0.005, maxDraw: 110000, debtLimit: 33000, drawFee: 0.01 }),
  ...
  Object.freeze({
    ...
    edge: Object.freeze([
      'A real deposit, and nothing behind it',
    ...
    loan: Object.freeze({ interestWeekly: 0.012, maxDraw: 96000, debtLimit: 29000 }),
    targets: Object.freeze({
  ...
  Object.freeze({
    ...
    lede: 'You have a record, a lease, and a man who wants his money on Thursday.',
    body: Object.freeze([
    ...
    edge: Object.freeze([
      'Barely enough to put a rig and a hauler on the board, and nothing spare',
    ...
    loan: Object.freeze({ interestWeekly: 0.017, maxDraw: 62000, debtLimit: 34000, drawFee: 0.05 }),
    ...
    targets: Object.freeze({
      // Every origin's first act is now the same purchase — a rig, a hauler and the coil line,
      // borrowed if it has to be — and every company is then capped by the same single production
      // line, so share at week 20 converges. What separates hard is that it gets there on 1.7% a
      // week with a 5% draw fee and busts a third of the time, not that it stays small.
      bust: Object.freeze({ min: 0.16, max: 0.40 }), share13: Object.freeze({ min: 0.06, max: 0.24 }),
