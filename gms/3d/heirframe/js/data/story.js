...
export const STORY_MISSIONS = [
  ...
  // Act 1 M2–M5 use hand-built step templates (tags resolve to sites; '@N' = the site of step N) so the story beats
  // line up with steps. packs: scripted {event, progress} ambushes fire on the route of their step.
  { id: 'a1_m2', act: 1, title: 'Something Borrowed', gate: 2, archetype: 'retrieve', district: 'aurum_plaza', clues: ['C02'], faction: 'syndicate',
    blurb: 'A pawn-droid called Tinsel says it can read the key. Mara is paying.',
    steps: [
      { type: 'goto', tags: ['market', 'plaza'], radius: 5, label: "Find Tinsel's stall in the market row" },
      { type: 'hack', at: 0, time: 3, verb: 'Let Tinsel scan the key', label: 'Let Tinsel scan the heir-key' },
      { type: 'goto', tags: ['alley', 'spawn_edge'], radius: 6, far: true, label: 'Slip out through the service alley' },
      { type: 'kill', target: 'all', label: 'Silverhand thugs: deal with them' },
      { type: 'goto', tags: ['terminal', 'plaza', 'fountain'], radius: 5, label: "Back to Mara's kiosk" },
    ],
    packs: [{ atStep: 2, at: 2, scripted: { event: 'ambush', progress: 0.45 }, units: [['knuckle', 'grunt', 2], ['popper', 'grunt', 1]] }] },
  { id: 'a1_m3', act: 1, title: 'Brightline', gate: 3, archetype: 'surveil', district: 'brightline', clues: ['C03'], unlocks: ['brightline'], faction: 'syndicate', stealthy: true,
    blurb: 'Photograph a Syndicate courier on the boulevard. Stay out of his eyeline.',
    target: { defId: 'vip', rank: 'grunt', name: 'Silverhand courier', at: 0 },
    steps: [
      { type: 'goto', tags: ['plaza', 'market'], radius: 12, label: 'Find the Silverhand courier' },
      { type: 'photo', target: 'target', at: 0, shots: 3, holdTime: 2.2, maxDist: 14, label: 'Three clean shots of who he meets' },
      { type: 'exfil', tags: ['relay', 'spawn_edge', 'alley'], radius: 5, far: true, label: 'Get clear before his crew clocks you' },
    ],
    packs: [{ atStep: 1, at: 0, guard: true, units: [['knuckle', 'grunt', 2]] }] },
  { id: 'a1_m4', act: 1, title: 'The Kettle Boils', gate: 5, archetype: 'defend', district: 'aurum_plaza', clues: ['C04'], boss: 'big_kettle', bossAt: 'defend', faction: 'syndicate',
    grants: { firstFrameDiscount: true }, blurb: "Big Kettle's crew is coming for the key. Get a real frame, then hold Mara's kiosk.",
    steps: [
      { type: 'goto', tags: ['link_pad', 'relay', 'plaza'], radius: 4, label: "Sal Venn's frame lot: your own frame, 30% off" },
      { type: 'goto', tags: ['terminal', 'market', 'plaza'], radius: 6, label: "Get back to Mara's kiosk" },
      { type: 'defend', at: 1, object: 'kiosk', objHpMult: 10, waves: 3, duration: 75, spawnTags: ['spawn_edge', 'alley'], label: "Hold Mara's kiosk" },
      { type: 'goto', at: 1, radius: 5, label: 'Check on Mara' },
    ] },
  { id: 'a1_m5', act: 1, title: 'Unperson', gate: 7, archetype: 'hack', district: 'aurum_plaza', clues: ['C05'], reveal: 'R1', faction: 'concord', setHeat: 3,
    blurb: 'Break into the civic-records node under the statue and match your genome.',
    steps: [
