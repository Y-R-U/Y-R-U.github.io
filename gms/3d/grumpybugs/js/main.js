// GRUMPY BUGS — boot, mode machine, the loop. Modes: menu (live 3D backdrop),
...
import { applyRenderProfile } from './render.js';
...
applyRenderProfile(renderer, { lite: liteMode });
...
const deps = { fx, cams, dom: renderer.domElement, renderer };
