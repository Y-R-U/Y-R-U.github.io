...
// Player stat caps (prevent runaway power)
const SPEED_CAP  = 22; // max units/s
const MAGNET_CAP = 20; // max radius units
...
const ENEMY_PROPS = {
  rookie:   { color: COLORS.rookie,    startCrowd: [3, 8],   speed: 5.0, senseRange: 15, huntRange: 15 },
...
const UPGRADE_DEFS = [
  { id: 'speed',     icon: '🏃', name: 'Speed',            desc: '+8% movement speed per level (cap 22 u/s)', maxLevel: 5, costs: [10, 25, 50, 100, 200] },
  { id: 'magnet',    icon: '🧲', name: 'Magnet',            desc: '+15% collect radius per level (cap 20 u)',  maxLevel: 5, costs: [10, 25, 50, 100, 200] },
  ...
  { id: 'steal',     icon: '🫴', name: 'Follower Steal',    desc: 'Steal N followers from enemy on contact',   maxLevel: 5, costs: [20, 45, 90, 180, 360] },
];
...
const IG_UPGRADES = [
  { id: 'speedSurge', icon: '⚡', name: 'Speed Surge',      desc: '+25% speed for this run (capped)'           },
  { id: 'massMagnet', icon: '🧲', name: 'Mass Magnet',      desc: '+40% magnet range this run (capped)'        },
  ...
  { id: 'curse',      icon: '🧿', name: 'Curse Leader',     desc: 'Top-ranked enemy earns followers at ½ speed for 30 s' },
