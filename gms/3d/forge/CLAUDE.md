...
| Orientation | **Landscape only.** Portrait gets a rotate prompt. The entire building-scale derivation assumes landscape's 96.8° horizontal FOV; in portrait it collapses to 27.1° and the numbers are void. |
