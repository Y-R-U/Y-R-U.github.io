...
import { TANK, ZONE } from './config.js';
...
export class AIController {
  ...
  decide() {
    ...
    // someone is close (or hit us), and let the storm force the endgame
  ...
  steer(dt) {
    ...
    if (this.mode === 'engage' && this.target && this.target.alive) {
      ...
      _v.y = 0;
      _v.normalize();
      // run away, but bend toward the zone center so the storm doesn't get us
    ...
    // storm override: get inside, fast
