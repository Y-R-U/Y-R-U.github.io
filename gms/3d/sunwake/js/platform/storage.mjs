...
export function createStorage(notice){
 ...
 save(boat,exploration,settings){try{localStorage.setItem(SAVE_KEY,encodeSave(boat,exploration,settings));return true;}catch{notice('Progress stays in this session');return false;}}};
}
