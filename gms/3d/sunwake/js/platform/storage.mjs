...
export function createStorage(notice){
 ...
 save(boat,exploration,settings,fishing,jobs){try{localStorage.setItem(SAVE_KEY,encodeSave(boat,exploration,settings,fishing,jobs));return true;}catch{notice('Progress stays in this session');return false;}}};
}
