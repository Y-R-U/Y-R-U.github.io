...
import { heightAt, nearCamera } from './terrain.js';
...
export class People {
  ...
  // Who Fights has no ambient crowd: every figure in the world is a character from
  ...
  registerKnobs(q) {
    q.register({ key: 'crowd', label: 'Crowd', type: 'range', min: 0, max: POOL, step: 4, default: POOL, group: 'People' },
      v => this.setCrowd(v));
