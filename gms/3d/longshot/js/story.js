...
export const STORY = [
  // ═══ ACT 1 — THE CONTRACT ═══
  {
    ...
    brief: 'Before I put paying work in front of you, Wren, prove the years off the glass didn\'t soften you. Three steel plates, three distances. Scope in, mind the drop, hold your breath when it matters. And note the street under them — steel doesn\'t bleed, but everything below it does. Miss loud enough and you\'ll watch a whole block react.',
    intel: ['Tap <b>◎</b> to scope, slider or pinch to zoom', 'NEVER fire unscoped — a hip shot misses by metres', 'The round FALLS — use the dots below the crosshair', 'Hold <b>🫁</b> to steady. Watch the breath bar', 'People down there are real: a civilian costs <b>2 500</b>'],
    time: 'dusk', wind: [0, 0], vantage: { dist: 140, height: 34 },
    special: 'range', setup: { civs: 6 },
  },
  {
    ...
    intel: ['Target: <b>Marco Bellan</b> — on his phone by the fountain', 'MARK <b>◈</b> him first — the diamond stays on him', 'Short range: drop is barely a dot', 'One loud miss near him and he runs — <b>the contract voids</b>'],
  ...
  },
  {
    ...
    intel: ['Target works a lit corner office', 'Standard rounds deflect off glass — aim centre mass, or buy AP later', 'Rangefinder scopes read the exact distance', 'Miss the window and he takes cover: <b>13 s</b> to finish it'],
  ...
  },
  {
    ...
    intel: ['THREE targets: plaza, street, rooftop', '<b>20 s</b> window once the first falls', 'Fast-cycling rifles earn their money tonight', 'Top the magazine up BEFORE you open — <b>⟳ R</b> or tap the ammo pips'],
...
export const RANGE_DEF = {
  ...
  intel: ['Three plates at three ranges', 'Free retry, no stakes', 'There IS wind here — the arrow up top shows where it pushes the round'],
