...
export class CDP {
   ...
   */
  /**
   * Full-page capture INCLUDING DOM overlays. Page.captureScreenshot is unsafe on an
   * animating WebGL canvas, but this game is 2D canvas only, and menus live in the DOM
   * so canvas-only capture misses every button.
   */
  async shot(file) {
