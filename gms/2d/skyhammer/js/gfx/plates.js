...
//
// Contract per key is documented in docs/GFX_NOTES.md — dimensions, horizontal tiling
...
export const PLATE_SPECS = Object.freeze({
  sky:       { w: 256,  h: 512,  tileX: true,  tileY: false, parallax: 0.02, tint: 'baked-per-palette', stretch: 'world-y-mapped' },
  ...
  earthtex:  { w: 256,  h: 256,  tileX: true,  tileY: true,  parallax: 1.00, tint: 'baked-per-palette' },
  // FX sprites go through the same door so a hand-authored replacement drops in the same way.
  fire:      { w: 128,  h: 128,  tileX: false, tileY: false, parallax: 1.00, tint: 'additive' },
  smoke:     { w: 128,  h: 128,  tileX: false, tileY: false, parallax: 1.00, tint: 'alpha' },
  spark:     { w: 64,   h: 64,   tileX: false, tileY: false, parallax: 1.00, tint: 'additive' },
  ring:      { w: 256,  h: 256,  tileX: false, tileY: false, parallax: 1.00, tint: 'additive' },
  scorch:    { w: 128,  h: 128,  tileX: false, tileY: false, parallax: 1.00, tint: 'alpha' },
  streak:    { w: 128,  h: 32,   tileX: false, tileY: false, parallax: 1.00, tint: 'additive' },
  halo:      { w: 256,  h: 256,  tileX: false, tileY: false, parallax: 1.00, tint: 'additive' },
});
