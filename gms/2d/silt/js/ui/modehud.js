...
export function createModeHud() {
  ...
  function setObjective(a) {
    ...
    // EVERY objective in the campaign counts UP to a target. The one that
    // counted down to a ceiling — reduce standing sand to N — is gone: see
    // levelgen's slag case. tools/modesim.mjs holds the table to that.
