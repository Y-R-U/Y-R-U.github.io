...
import { fbm1 } from './gmath.js';

export const MAX_LIGHTS = 256;
const STRIDE = 12;   // x,y,radius,parallaxX | r,g,b,soft | squash,angle,parallaxY,_
...
export function createLights(gl, quadBuf, opts = {}) {
  ...
  const L = {
     ...
     */
    add(x, y, radius, r, g, b, intensity, flicker, squash, angle, parallax, soft, parallaxY) {
      ...
      data[o + 10] = parallaxY === undefined ? (parallax === undefined ? 1 : parallax) : parallaxY;
      data[o + 11] = 0;
      count++;
    },
